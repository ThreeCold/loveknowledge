...
<head>
    ...
    <style type="text/css">
        ...
        #button {
            width: 133px;
            height: 133px;
            background-image: url('/love/images/play.png');
            position: absolute;
            z-index: 1000;
            margin-left: -66px;
            left: 50%;
...
<div id="vvg">
    ...
    <p id="imgDiy">填入图片地址：<input type="text" id="imgUrl"><input id="startDiy" type="button" value="开始" style="margin-bottom:10px;margin-left:20px;"></p>
    <div id="vvgBox">
        <ul id="gameCanvas"></ul>
    </div>
</div>
    ...
    function tipNextStep() {
        ...
        if (vvg.step < 5) {
            playBtn.onclick = function () {
                ...
                makeGame('/love/images/0' + vvg.step + '.jpg');
            }
        } else {
            playBtn.onclick = function () {
                while (canvas.firstChild) {
